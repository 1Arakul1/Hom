...
class LinkedList:
    ...
    def insert_at_head(self, data):
        ...
        :return: Сообщение об успешном добавлении узла.
        """
        new_node = Node(data)
    ...
    def remove_node_position(self, rm_position):
        ...
        :return: Сообщение об успешном удалении узла или сообщение об ошибке.
        """
        if rm_position == 1:
    ...
    def insert_at_position(self, data, node_position):
        """
        Вставка узла на указанную позицию.
    ...
    def print_ll(self):
        """Вывод всех данных списка на экран."""
        current_node = self.head
        while current_node:
    ...
    def get(self, data):
        ...
        :return: Кортеж с результатом поиска и найденным узлом.
        """
        current_node = self.head
        while current_node:
    ...
    def change_data(self, node_data, change_data):
        ...
        :param node_data: Данные узла, которые нужно изменить.
        :param change_data: Новые данные для узла.
        :return: Сообщение об успешном изменении данных.
        """
        current_node = self.head
        current_node_position = 1
        while current_node:
